			...
			<div class="row">
				<div class="col-xs-12 col-sm-3 col-md-2 sidebar">
					...
					<ul class="nav nav-sidebar">
						<li  class="active">
							<a href="prdManage.php">需求文档管理 <span class="sr-only">(current)</span></a>
						</li>
						<li>
				...
				<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
					<h1 class="page-header">需求文档管理</h1>
					<div class="table-responsive no-border">
						<!-- Button trigger modal -->
						<button type="button" class="btn btn-primary btn-lg" data-toggle="modal" data-target="#creatModal">
						  新增
						</button>
						<button id="editPrdBtn" type="button" class="btn btn-primary btn-lg" data-target="#editModal">
						  编辑
						</button>
						<button id="deletePrdBtn" type="button" class="btn btn-primary btn-lg">
						  删除
						</button>
		  ...
		  <div class="modal-dialog" role="document">
		    <div class="modal-content">
		      ...
		      <div class="modal-footer">
		        ...
		        <button type="button" id="creatPrdInfo" class="btn btn-primary">确定</button>
		      </div>
		...
		<div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
		  <div class="modal-dialog" role="document">
		    <div class="modal-content">
		      ...
		      <div class="modal-footer">
		        <button type="button" class="btn btn-default" data-dismiss="modal">取消</button>
		        <button type="button" id="editPrdInfo" class="btn btn-primary">确定</button>
		      </div>
			...
			$(function() {
				...
				$dataGridTable.bootstrapTable({
				    ...
				    columns: [ {
				        ...
				        title: '所属版本',
				        formatter:function(value,row,index){
				        	//alert(value+'=='+row.f_title.toString()+'=='+index);//row.f_title row相当于列表的所有返回值，可以通过“.”+field展示出具体值；
				        	return PRDVersionJson[value];
	                    } 
				    },{
				        field: 'f_function',
				        title: '所属功能',
				        formatter:function(value,row,index){
				        	alert(JSON.stringify(PRDFunctionJson.business.item.functionId));
				        	//return PRDFunctionJson.;
	                    }
				    },{
				        field: 'f_developer_id',
				        title: '开发者'
				    },{
				        field: 'f_prodect_manager_id',
				        title: '产品人员'
				    },{
				        field: 'f_tester_id',
				        title: '测试人员'
				        ...
				        field: 'f_create_operator',
				        title: '创建人'
				    },{
				        field: 'f_create_date',
				        title: '创建时间'
				    },{
				        field: 'f_end_operator',
				        title: '最后修改人'
				    },{
				        field: 'f_end_operate_date',
				        title: '最后修改时间'
				    }]
				});
				//新增项目
/*				$('#creatPrdInfo').click(function() {
